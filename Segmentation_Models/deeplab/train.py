...
# Dataset settings.
# osm datasets 'world_tiny2k' 'de_top15' 'eu_top25'
flags.DEFINE_string('dataset', 'pascal_voc_seg',
                    'Name of the segmentation dataset.')

flags.DEFINE_string('train_split', 'train',
                    'Which split of the dataset to be used for training (train, test, val)')

flags.DEFINE_string('val_split', 'val',
                    'Which split of the dataset to be used for validation (train, test, val)')
