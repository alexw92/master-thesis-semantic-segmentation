...
tf.app.flags.DEFINE_string('osm_root',
                           './deeplab_tiny_world2k',
                           'OSM dataset root folder.')

tf.app.flags.DEFINE_string(
    'output_dir',
    './deeplab_tiny_world2k/tfrecord',
...
# Image file pattern.
_IMAGE_FILENAME_RE = re.compile('(.+)' + _DATA_FORMAT_MAP['image'])
...
def _get_files(data, dataset_split):
  ...
  search_files = os.path.join(
      FLAGS.osm_root, _FOLDERS_MAP[data], dataset_split, pattern)
  print(search_files)
