...
_WORLD_TINY2K_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 1472,
        'test': 184,
        'val': 184,
...
_DE_TOP15_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 5626,
        'test': 703,
        'val': 703,
...
_EU_TOP25_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 11921,
        'test': 1490,
        'val': 1490,
...
_NORES_WORLD_TINY2K_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 1472,
        'test': 184,
        'val': 184,
...
_NORES_DE_TOP15_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 5626,
        'test': 703,
        'val': 703,
...
_NORES_EU_TOP25_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 11921,
        'test': 1490,
        'val': 1490,
...
_KAGGLE_DSTL_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 480,
        'test': 60,
        'val': 60,
...
_VAIHINGEN_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 264,
        'test': 0,
        'val': 30,
...
_DATASETS_INFORMATION = {
    ...
    'world_tiny2k': _WORLD_TINY2K_INFORMATION,
    'de_top15': _DE_TOP15_INFORMATION,
    'eu_top25': _EU_TOP25_INFORMATION,
    'world_tiny2k_nores': _NORES_WORLD_TINY2K_INFORMATION,
    'de_top15_nores': _NORES_DE_TOP15_INFORMATION,
    'eu_top25_nores': _NORES_EU_TOP25_INFORMATION,
    'kaggle_dstl':_KAGGLE_DSTL_INFORMATION,
    'vaihingen':_VAIHINGEN_INFORMATION
}
...
def get_classname(dataset_name, class_id):
    """
    Returns the class name for a given class_id of dataset dataset_name
    :param dataset_name:
    :param class_id:
    :return: The class name of the given id
    """
    if dataset_name not in _DATASETS_INFORMATION:
        raise ValueError('The specified dataset is not supported yet. ')

    if 'de_top' in dataset_name or 'world' in dataset_name or 'eu_top' in dataset_name:
        class_names = osm_class_name
    elif 'kaggle' in dataset_name:
        class_names = kaggle_class_names
    elif 'vaihingen' in dataset_name:
