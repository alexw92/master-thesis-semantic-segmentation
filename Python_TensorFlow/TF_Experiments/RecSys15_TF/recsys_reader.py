...
def create_feature_sets_and_labels(pos, neg, test_size = 0.1, max_lines = 100000):
    lexicon = create_lexicon(pos, neg, max_lines)
    features = []
...
if __name__ == '__main__':
    datadir = '../../../ANN_DATA/RecSys15'
    train_x, train_y, test_x, test_y = create_feature_sets_and_labels(datadir+'/yoochoose-buys.dat')
    with open(datadir+'recsys_set_pickle', 'wb') as f:
